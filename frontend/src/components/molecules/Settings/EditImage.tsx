...
function EditImage(props: EditImageProps) {
  ...
  return (
    <div className="flex flex-col justify-center items-center border-solid border-8 border-light-fg-link dark:border-light-bg-secondary rounded-lg bg-light-bg-tertiary max-w-max py-5 px-20">
