      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="flex flex-col items-start w-full max-w-max p-16 rounded-lg bg-light-bg-tertiary dark:bg-dark-bg-primary space-y-8">
                <span className="text-lg text-light-fg-primary dark:text-light-fg-tertiary">
                ...
                <div>
                  ...
                  {isHidden && (
                    <output className="text-lg text-light-fg-primary border-dashed border-2 rounded-xxl p-2">
                      DL545KSKNJSDL
                    </output>
                  )}
                </div>
