...
function ButtonOAuth() {
  return (
    <div className="inline-flex justify-between p-1 w-40 -rotate-32 items-center bg-light-fg-link rounded-full border-4 border-light-fg-primary dark:border-dark-fg-primary">
